...
class User < ActiveRecord::Base
  ...
  attr_accessible :password, :password_confirmation, :login, :firstname, :lastname, :mail, :locale,
    :timezone, :auth_source_id, :mail_enabled, :location_ids, :location_names,
    :default_location_id, :organization_ids, :organization_names, :default_organization_id,
    :auth_source, :role_ids, :role_names, :mail_notification_ids, :mail_notification_names,
