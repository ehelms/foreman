...
class Ptable < Template
  ...
  attr_accessible :layout, :location_ids, :location_names, :organization_ids, :organization_names,
    :name, :default, :snippet, :os_family, :audit_comment, :operatingsystem_ids,
    :operatingsystem_names, :host_ids, :host_names, :hostgroup_names, :hostgroup_ids
