class LookupKey < ActiveRecord::Base
  ...
  attr_accessible :key, :description, :override, :key_type, :default_value, :required,
    :validator_type, :use_puppet_default, :validator_rule, :path, :variable, :id, :is_param,
    :puppetclass_id, :lookup_values_attributes, :lookup_values
